...
<body>
<nav class="nav <?php if($_SERVER["PHP_SELF"]=="index.php")echo "--nav-inicio"?>" id="nav">
  <img src="/assets/imgs/Logo.png" class="logo --no-margin">
  <div class="menu">
    <a href="/">Inicio</a>
    <div class="sub-menu-container hover-list" id="sub-menu-container">
      ...
      <div class="sub-menu">
        <a href="/products/vr-basic">Dreamtech VR Basic</a>
        <a href="/products/vr-pro">Dreamtech VR Pro</a>
        <a href="/products/traje">Dreamtech Suit</a>
        <a href="/products/guantes">Dreamtech Gloves</a>
      </div>
    </div>
...
<?php endif?>
<?php echo $contenido?>
<footer <?php if($_SERVER["PHP_SELF"]=="views/about-us.php") echo "class='--no-margin'"?>>
  <h3>¡Te esperamos en el mundo VR!</h3>
  <div class="footer-content">
    <div class="col --col-1">
      <a href="/products/vr-basic">Dreamtech VR Basic</a>
      <a href="/products/vr-pro">Dreamtech VR Pro</a>
      <a href="/products/traje">Suit</a>
      <a href="/products/guantes">Dreamtech Gloves</a>
    </div>
    <div class="col --col-2">
      <a href="/">Inicio</a>
  ...
  <img class="footer-logo" src="/assets/imgs/Logo.png">

<footer <?php if($_SERVER["PHP_SELF"]=="/public/views/about-us.php") echo "class='--no-margin'"?>>
  ...
  <div class="footer-content">
    <div class="col --col-1">
      ...
      <a href="/public/views/products/traje.php">Suit</a>
  ...
  <img class="footer-logo" src="/public/assets/imgs/Logo.png">
